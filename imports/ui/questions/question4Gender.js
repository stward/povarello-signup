...
const Question4 = (props) =>
  <div className="row">
    ...
    {props.info.editingQuestion === true ?
      <Link to={`/questions/8`}><button className="question-button" value="male" onClick={(event) => props.onChangeHandler("gender", event.target.value)}> Male </button></Link>
    ...
    {props.info.editingQuestion === true ?
      <Link to={`/questions/8`}><button className="question-button" value="female" onClick={(event) => props.onChangeHandler("gender", event.target.value)}> Female </button></Link>
